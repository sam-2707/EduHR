...
export default function Home() {
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 via-white to-purple-50">
      ...
      {/* Interactive Demo */}
      <section id="demo" className="py-12 sm:py-16 lg:py-20 relative">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-8 sm:mb-12 lg:mb-16">
            <h3 className="text-2xl sm:text-3xl font-bold text-gray-900 mb-4">
          ...
          <div className="max-w-4xl mx-auto px-2 sm:px-4 relative z-10">
            <HRGuruChat schoolId="demo-school" className="shadow-2xl w-full relative" />
          </div>
        </div>
      </section>

      {/* Statistics */}
      <section className="py-12 sm:py-16 lg:py-20 bg-gray-900 text-white relative z-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
